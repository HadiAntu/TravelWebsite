        ...
        <div class="col-lg-8 ml-auto">
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <h2 class="footer-heading mb-4">Testimonial</h2>
              <p>This is something like a testimonial.Feel free to share your review with us</p>
              <form action="{{route('testimonial')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                <input type="text"  name="testimonial" class="form-control mr-3" placeholder="Testimonial">
